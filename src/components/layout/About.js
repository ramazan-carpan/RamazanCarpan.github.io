...
import WhoIam from '../../assets/img/profil/WhoIam.jpg';
...
const About = () => {
  return (
    <section className="about-me" id="about">
      ...
      <img src={WhoIam} alt="Profile" className="about-me__img" />
    </section>
  );
};
